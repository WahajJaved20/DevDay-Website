    ...
    return (<>
        ...
        <div className="inline-block lg:flex lg:justify-evenly lg:align-center mt-28">
          ...
          <div className="w-full lg:w-2/5">
                ...
                <p className="text-black font-circularStd font-semibold text-lg lg:text-lg xl:text-lg">In the dynamic world of ACM DevDay, the Extended Executive Committee (2023-2024) embodies proactive leadership and effective collaboration. As trailblazers in their fields, their transformative influence promises a lasting legacy, inspiring excellence in others. Cheers to an exceptional tenure!</p>
            </div>
        </div>

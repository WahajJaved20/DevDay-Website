    ...
    <div className="min-h-screen flex items-center justify-center bg-primaryColor">
      <div className="bg-white p-8 rounded-lg shadow-md w-full sm:max-w-md md:max-w-lg lg:max-w-xl">
        ...
        <ul className="list-disc pl-4 mb-6">
          ...
          <li>
            Shoot us a message - we're always happy to help! You can find me on Github and raise an issue at <a target="_blank" href="https://github.com/WahajJaved20/DevDay-Website" className="underline">DevDay Github</a>.
          </li>
        </ul>
